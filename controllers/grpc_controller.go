...
// 		//fmt.Println(err)
// 		if err != nil {
// 			log.Println("Failed at reconcile")
// 			vl = "Failed at reconcile"
// 			resp = nil
// 			//	req := curl.NewRequest(nil)
// 			goto L
// 		}
// 		str := rune(resp.StatusCode)
// 		vl = "Sucess at reconcile"
// 		log.Println("Sucess at reconcile", str)
// 	}
// }
...
func (r *GrpcReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	...
	//fmt.Println(err)
	if err != nil {
		fmt.Println("Failed at reconcile")
		vl = "Failed at reconcile"
		resp = nil
		//	req := curl.NewRequest(nil)
	...
	str := rune(resp.StatusCode)
	vl = "Sucess at reconcile"
	fmt.Println("Sucess at reconcile", str)
	...
	grpc.Status.Status = vl
	fmt.Println(grpc.Status.Status)
	err = r.Status().Update(ctx, grpc)
	if err != nil {
		return reconcile.Result{}, err
	}

	// if !reflect.DeepEqual(vl, grpc.Status.Status) {
	// 	grpc.Status.Status = vl
	// 	err := r.Status().Update(ctx, grpc)
	// 	if err != nil {
	// 		// got error, requeue
